...
The accuracy on Java reached 72.3\% (an absolute improvement of 4.6\%). Furthermore, experiments on various programming languages demonstrate MergeCoT’s superior multilingual versatility and cross-language
...
\hline
Language                    & Model                                                                      & Precision (\%) & Accuracy (\%) \\ \hline
\multirow{2}{*}{Javascript} & \begin{tabular}[c]{@{}c@{}}MergeCoT\end{tabular} & \textbf{68.7}  & \textbf{67.9} \\
                            & Direct Generation                                                          & 66.2           & 65.3          \\
\multirow{2}{*}{Typescript} & \begin{tabular}[c]{@{}c@{}}MergeCoT\end{tabular} & \textbf{66.5}  & \textbf{62.1} \\
                            & Direct Generation                                                          & 64.5           & 60.8          \\ \hline
\end{tabular}
\label{tab: Verification of unknown languages}
\end{table}
Results show that MergeCoT trained on Java achieves a precision of 68.7\% and an accuracy of 67.9\% on the JavaScript test set, and 66.5\% and 62.1\% on the TypeScript test set, respectively. Under the same conditions, the direct generation baseline attains a precision of only 66.2\% and an accuracy of 65.3\% on JavaScript, and 64.5\% and 60.8\% on TypeScript.
